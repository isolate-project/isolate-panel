...
type ConfigContext struct {
	...
	// GetCoreAPISecret retrieves the per-core API secret for Clash-compatible API (sing-box, mihomo).
	// This callback allows retrieving the plaintext key from encrypted storage.
